...
Current product completion focuses on consistent HWP/HWPX and XLSX structure and
understanding across varied layouts and forms. Use native fixtures and format-limited
runs. Compare complete hierarchy, fields/records, values, relationships, missingness
and source bindings against prior expectations. Different layouts of equivalent
content and genuinely different forms must both be covered. This runner evaluates
extraction; a reconstruction writer is not a KPI requirement. Completion criteria
are specified in [SUPPORT.md](../SUPPORT.md).
